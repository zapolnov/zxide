...
private:
    ...
    bool wordLiteral(std::unique_ptr<Expression>* out, bool unambiguous = false) const { return mParser->matchExpression(out, unambiguous); }
    ...
    AssemblerParser::OpcodeParseResult opcode_and()
    {
        if (ident("a")) {
            ...
            if (token(T_COMMA)) {
                if (ident("a")) {
                    if (eol())
                        return mCodeEmitter->emit<AND_A_A>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("b")) {
                    if (eol())
                        return mCodeEmitter->emit<AND_A_B>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("c")) {
                    if (eol())
                        return mCodeEmitter->emit<AND_A_C>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("d")) {
                    if (eol())
                        return mCodeEmitter->emit<AND_A_D>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("e")) {
                    if (eol())
                        return mCodeEmitter->emit<AND_A_E>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("h")) {
                    if (eol())
                        return mCodeEmitter->emit<AND_A_H>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("l")) {
                    if (eol())
                        return mCodeEmitter->emit<AND_A_L>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (byteLiteral(&mLiteral1)) {
                    if (eol())
                        return mCodeEmitter->emit<AND_A_n>(mToken, std::move(mLiteral1)), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (token(T_LPAREN)) {
                    if (ident("hl")) {
                        if (token(T_RPAREN)) {
                            if (eol())
                                return mCodeEmitter->emit<AND_A_mHL>(mToken), AssemblerParser::OpcodeParseResult::Success;
                            return AssemblerParser::OpcodeParseResult::SyntaxError;
                        }
                        return AssemblerParser::OpcodeParseResult::SyntaxError;
                    }
                    if (ident("ix")) {
                        if ((mLiteral1 = zero()), token(T_RPAREN)) {
                            if (eol())
                                return mCodeEmitter->emit<AND_A_mIXn>(mToken, std::move(mLiteral1)), AssemblerParser::OpcodeParseResult::Success;
                            return AssemblerParser::OpcodeParseResult::SyntaxError;
                        }
                        if (token(T_PLUS)) {
                            if (byteLiteral(&mLiteral1)) {
                    ...
                    if (ident("iy")) {
                        if ((mLiteral1 = zero()), token(T_RPAREN)) {
                            if (eol())
                                return mCodeEmitter->emit<AND_A_mIYn>(mToken, std::move(mLiteral1)), AssemblerParser::OpcodeParseResult::Success;
                            return AssemblerParser::OpcodeParseResult::SyntaxError;
                        }
                        if (token(T_PLUS)) {
                            if (byteLiteral(&mLiteral1)) {
                ...
                if (ident("ixh")) {
                    if (eol())
                        return mCodeEmitter->emit<AND_A_IXH>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("iyh")) {
                    if (eol())
                        return mCodeEmitter->emit<AND_A_IYH>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("ixl")) {
                    if (eol())
                        return mCodeEmitter->emit<AND_A_IXL>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("iyl")) {
                    if (eol())
                        return mCodeEmitter->emit<AND_A_IYL>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                return AssemblerParser::OpcodeParseResult::SyntaxError;
            }
    ...
    AssemblerParser::OpcodeParseResult opcode_cp()
    {
        if (ident("a")) {
            ...
            if (token(T_COMMA)) {
                ...
                if (byteLiteral(&mLiteral1)) {
                    if (eol())
                        return mCodeEmitter->emit<CP_A_n>(mToken, std::move(mLiteral1)), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (token(T_LPAREN)) {
                    if (ident("hl")) {
                        if (token(T_RPAREN)) {
                            if (eol())
                                return mCodeEmitter->emit<CP_A_mHL>(mToken), AssemblerParser::OpcodeParseResult::Success;
                            return AssemblerParser::OpcodeParseResult::SyntaxError;
                        }
                        return AssemblerParser::OpcodeParseResult::SyntaxError;
                    }
                    if (ident("ix")) {
                        if ((mLiteral1 = zero()), token(T_RPAREN)) {
                            if (eol())
                                return mCodeEmitter->emit<CP_A_mIXn>(mToken, std::move(mLiteral1)), AssemblerParser::OpcodeParseResult::Success;
                            return AssemblerParser::OpcodeParseResult::SyntaxError;
                        }
                        if (token(T_PLUS)) {
                            if (byteLiteral(&mLiteral1)) {
                    ...
                    if (ident("iy")) {
                        if ((mLiteral1 = zero()), token(T_RPAREN)) {
                            if (eol())
                                return mCodeEmitter->emit<CP_A_mIYn>(mToken, std::move(mLiteral1)), AssemblerParser::OpcodeParseResult::Success;
                            return AssemblerParser::OpcodeParseResult::SyntaxError;
                        }
                        if (token(T_PLUS)) {
                            if (byteLiteral(&mLiteral1)) {
                ...
                if (ident("ixh")) {
                    if (eol())
                        return mCodeEmitter->emit<CP_A_IXH>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("iyh")) {
                    if (eol())
                        return mCodeEmitter->emit<CP_A_IYH>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("ixl")) {
                    if (eol())
                        return mCodeEmitter->emit<CP_A_IXL>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("iyl")) {
                    if (eol())
                        return mCodeEmitter->emit<CP_A_IYL>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                return AssemblerParser::OpcodeParseResult::SyntaxError;
            }
        ...
        if (ident("a")) {
            if (token(T_COMMA)) {
                if (token(T_LPAREN)) {
                    ...
                    if (mParser->lastTokenId() == T_LPAREN) {
                        if (wordLiteral(&mLiteral1, true)) {
                            if (token(T_RPAREN)) {
                                if (eol())
    ...
    AssemblerParser::OpcodeParseResult opcode_or()
    {
        if (ident("a")) {
            ...
            if (token(T_COMMA)) {
                if (ident("a")) {
                    if (eol())
                        return mCodeEmitter->emit<OR_A_A>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("b")) {
                    if (eol())
                        return mCodeEmitter->emit<OR_A_B>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("c")) {
                    if (eol())
                        return mCodeEmitter->emit<OR_A_C>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("d")) {
                    if (eol())
                        return mCodeEmitter->emit<OR_A_D>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("e")) {
                    if (eol())
                        return mCodeEmitter->emit<OR_A_E>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("h")) {
                    if (eol())
                        return mCodeEmitter->emit<OR_A_H>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("l")) {
                    if (eol())
                        return mCodeEmitter->emit<OR_A_L>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (byteLiteral(&mLiteral1)) {
                    if (eol())
                        return mCodeEmitter->emit<OR_A_n>(mToken, std::move(mLiteral1)), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (token(T_LPAREN)) {
                    if (ident("hl")) {
                        if (token(T_RPAREN)) {
                            if (eol())
                                return mCodeEmitter->emit<OR_A_mHL>(mToken), AssemblerParser::OpcodeParseResult::Success;
                            return AssemblerParser::OpcodeParseResult::SyntaxError;
                        }
                        return AssemblerParser::OpcodeParseResult::SyntaxError;
                    }
                    if (ident("ix")) {
                        if ((mLiteral1 = zero()), token(T_RPAREN)) {
                            if (eol())
                                return mCodeEmitter->emit<OR_A_mIXn>(mToken, std::move(mLiteral1)), AssemblerParser::OpcodeParseResult::Success;
                            return AssemblerParser::OpcodeParseResult::SyntaxError;
                        }
                        if (token(T_PLUS)) {
                            if (byteLiteral(&mLiteral1)) {
                    ...
                    if (ident("iy")) {
                        if ((mLiteral1 = zero()), token(T_RPAREN)) {
                            if (eol())
                                return mCodeEmitter->emit<OR_A_mIYn>(mToken, std::move(mLiteral1)), AssemblerParser::OpcodeParseResult::Success;
                            return AssemblerParser::OpcodeParseResult::SyntaxError;
                        }
                        if (token(T_PLUS)) {
                            if (byteLiteral(&mLiteral1)) {
                ...
                if (ident("ixh")) {
                    if (eol())
                        return mCodeEmitter->emit<OR_A_IXH>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("iyh")) {
                    if (eol())
                        return mCodeEmitter->emit<OR_A_IYH>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("ixl")) {
                    if (eol())
                        return mCodeEmitter->emit<OR_A_IXL>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("iyl")) {
                    if (eol())
                        return mCodeEmitter->emit<OR_A_IYL>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                return AssemblerParser::OpcodeParseResult::SyntaxError;
            }
            ...
            if (token(T_COMMA)) {
                ...
                if (token(T_LPAREN)) {
                    if (ident("hl")) {
                        if (token(T_RPAREN)) {
                            if (eol())
                                return mCodeEmitter->emit<SUB_A_mHL>(mToken), AssemblerParser::OpcodeParseResult::Success;
                            return AssemblerParser::OpcodeParseResult::SyntaxError;
                        }
                        return AssemblerParser::OpcodeParseResult::SyntaxError;
                    }
                    if (ident("ix")) {
                        if ((mLiteral1 = zero()), token(T_RPAREN)) {
                            if (eol())
                                return mCodeEmitter->emit<SUB_A_mIXn>(mToken, std::move(mLiteral1)), AssemblerParser::OpcodeParseResult::Success;
                            return AssemblerParser::OpcodeParseResult::SyntaxError;
                        }
                        if (token(T_PLUS)) {
                            if (byteLiteral(&mLiteral1)) {
                    ...
                    if (ident("iy")) {
                        if ((mLiteral1 = zero()), token(T_RPAREN)) {
                            if (eol())
                                return mCodeEmitter->emit<SUB_A_mIYn>(mToken, std::move(mLiteral1)), AssemblerParser::OpcodeParseResult::Success;
                            return AssemblerParser::OpcodeParseResult::SyntaxError;
                        }
                        if (token(T_PLUS)) {
                            if (byteLiteral(&mLiteral1)) {
                ...
                if (ident("ixh")) {
                    if (eol())
                        return mCodeEmitter->emit<SUB_A_IXH>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("iyh")) {
                    if (eol())
                        return mCodeEmitter->emit<SUB_A_IYH>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("ixl")) {
                    if (eol())
                        return mCodeEmitter->emit<SUB_A_IXL>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("iyl")) {
                    if (eol())
                        return mCodeEmitter->emit<SUB_A_IYL>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                return AssemblerParser::OpcodeParseResult::SyntaxError;
            }
    ...
    AssemblerParser::OpcodeParseResult opcode_xor()
    {
        if (ident("a")) {
            ...
            if (token(T_COMMA)) {
                ...
                if (byteLiteral(&mLiteral1)) {
                    if (eol())
                        return mCodeEmitter->emit<XOR_A_n>(mToken, std::move(mLiteral1)), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (token(T_LPAREN)) {
                    if (ident("hl")) {
                        if (token(T_RPAREN)) {
                            if (eol())
                                return mCodeEmitter->emit<XOR_A_mHL>(mToken), AssemblerParser::OpcodeParseResult::Success;
                            return AssemblerParser::OpcodeParseResult::SyntaxError;
                        }
                        return AssemblerParser::OpcodeParseResult::SyntaxError;
                    }
                    if (ident("ix")) {
                        if ((mLiteral1 = zero()), token(T_RPAREN)) {
                            if (eol())
                                return mCodeEmitter->emit<XOR_A_mIXn>(mToken, std::move(mLiteral1)), AssemblerParser::OpcodeParseResult::Success;
                            return AssemblerParser::OpcodeParseResult::SyntaxError;
                        }
                        if (token(T_PLUS)) {
                            if (byteLiteral(&mLiteral1)) {
                    ...
                    if (ident("iy")) {
                        if ((mLiteral1 = zero()), token(T_RPAREN)) {
                            if (eol())
                                return mCodeEmitter->emit<XOR_A_mIYn>(mToken, std::move(mLiteral1)), AssemblerParser::OpcodeParseResult::Success;
                            return AssemblerParser::OpcodeParseResult::SyntaxError;
                        }
                        if (token(T_PLUS)) {
                            if (byteLiteral(&mLiteral1)) {
                ...
                if (ident("ixh")) {
                    if (eol())
                        return mCodeEmitter->emit<XOR_A_IXH>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("iyh")) {
                    if (eol())
                        return mCodeEmitter->emit<XOR_A_IYH>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("ixl")) {
                    if (eol())
                        return mCodeEmitter->emit<XOR_A_IXL>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                if (ident("iyl")) {
                    if (eol())
                        return mCodeEmitter->emit<XOR_A_IYL>(mToken), AssemblerParser::OpcodeParseResult::Success;
                    return AssemblerParser::OpcodeParseResult::SyntaxError;
                }
                return AssemblerParser::OpcodeParseResult::SyntaxError;
            }
