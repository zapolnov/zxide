...
opcodes = [
        ...
        SimpleOpcode('otdr', [ 0xED, 0xBB ], [ 21, 16 ]),
        SimpleOpcode('otir', [ 0xED, 0xB3 ], [ 21, 16 ]),
        SimpleOpcode('outd', [ 0xED, 0xAB ], 16),
        SimpleOpcode('outi', [ 0xED, 0xA3 ], 16),
        SimpleOpcode( 'neg', [ 0xED, 0x44 ],  8),
        SimpleOpcode( 'nop', [ 0x00       ],  4),
        SimpleOpcode( 'ret', [ 0xC9       ], 10),
        SimpleOpcode('reti', [ 0xED, 0x4D ], 14),
        SimpleOpcode('retn', [ 0xED, 0x45 ], 14),
        SimpleOpcode( 'rla', [ 0x17       ],  4),
        SimpleOpcode('rlca', [ 0x07       ],  4),
        SimpleOpcode( 'rld', [ 0xED, 0x6F ], 18),
        SimpleOpcode( 'rra', [ 0x1F       ],  4),
