...
void LD_mIXn_n::emitBinary(Program* program, ProgramBinary* binary, IErrorReporter* reporter) const
{
    ...
    binary->emitByte(0x36);
    binary->emitByte(context1.evaluateByte(mLiteral1));
    binary->emitByte(context2.evaluateByte(mLiteral2));
}
